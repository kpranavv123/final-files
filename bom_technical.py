...
class BOMTableValidator:
    ...
    def validate(self):
        engine = BOMRuleEngine(self.part_fg_materials, self.site_plants)
    ...
    # ── Sub-count helpers ─────────────────────
    def _get_two_way_subcounts(self, field: str, blank_key: str, other_key: str) -> dict:
    ...
    def get_material_error_subcounts(self) -> dict:
        return self._get_two_way_subcounts("MATERIAL", "blank", "not_in_master")

    def get_plant_error_subcounts(self) -> dict:
        return self._get_two_way_subcounts("PLANT", "blank", "not_in_site")

    def get_component_error_subcounts(self) -> dict:
        return self._get_two_way_subcounts("COMPONENT", "blank", "not_in_master")

    def get_validfrom_error_subcounts(self) -> dict:
        return self._get_two_way_subcounts("VALIDFROM", "blank", "bad_format")

    def get_validto_error_subcounts(self) -> dict:
        return self._get_two_way_subcounts("VALIDTO", "blank", "bad_format")
