...
Business Rules:
  ...
  - REQUESTEDDELIVERYDATE should not be before acceptable range
...
BUSINESS_RULESET_INFO = {
    ...
    "REQUESTEDDELIVERYDATE": [
        "REQUESTEDDELIVERYDATE is before acceptable range (before 2026-04-07)",
    ],
    "DUPLICATES": [
...
class IndependentDemandBusinessRuleEngine:
    ...
    def validate_requested_delivery_date_range(self, row) -> tuple:
        ...
        # Invalid format/date is technical rule, so skip it here.
        ...
        one_month_ago = datetime(2026, 4, 7)

        if date_obj < one_month_ago:
            return False, "REQUESTEDDELIVERYDATE is before acceptable range (before 2026-04-07)"
...
class IndependentDemandBusinessReportWriter:
    ...
    def _write_ruleset_sheet(self, wb, summary_fields=None):
        ...
        title_cell = ws.cell(row=1, column=1, value="Independent Demand - Business Validation Rules")
        ...
        ruleset_info = {
            ...
            "REQUESTEDDELIVERYDATE": [
                "No more than 1 month of old transactions to be present.",
            ],
            "DUPLICATES": [
                "Duplicate records should not exist across all columns.",
            ],
    ...
    def _write_summary_sheet(self, wb, error_map: dict, total_rows: int):
        ...
        title_cell = ws.cell(row=1, column=1, value="Independent Demand Business Rules Summary (Run date: 26-May-2026)")
